...
export interface ExternalLinkProps extends React.ComponentPropsWithoutRef<typeof Link>, VariantProps<typeof buttonVariants> {}
...
const InternalLink = React.forwardRef<React.ComponentRef<typeof Link>, InternalLinkProps>(
  ({ className, variant, size, children, ...props }, ref) => {
    return (
      <Link
        ref={ref}
