...
const RadixUIIcon = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<'div'>
>(({ className, ...props }, ref) => (
  <div ref={ref} {...props} className='w-6 h-6 fill-black dark:fill-white'>
    <svg className='w-full h-full' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 25"><path d="M12 25a8 8 0 1 1 0-16v16zM12 0H4v8h8V0zM17 8a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" fill="currentcolor"/></svg>
  </div>
))
...
const TailwindCSSIcon = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<'div'>
>(({ className, ...props }, ref) => (
  <div ref={ref} {...props} className={cn('w-6 h-6', className)}>
